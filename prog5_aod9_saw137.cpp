...
void printIdInfo ( ostream &, string &, string &, string &, string &,
                  const string, string &, string &, string &, const string );
...
void getName ( string &first1, string &last1, string &first2, string &last2 )
{
    ...
    cout << endl << "Enter your team member's first name: ";
    cin >> first2;
...
void printIdInfo ( ostream &out, string &first1, string &last1, string &first2,
                   string &last2, const string CLASS, string &section,
                   string &lab_section1, string &lab_section2, const
                   string DUE_DATE )
{
    out << first1 << " " << last1 << " & " << first2 << " " << last2 << endl
        << CLASS << "." << section << endl
...
void writeFileLocation ( )
{
    cout << "Program results have been written to prog5_001out.txt." << endl;
}
